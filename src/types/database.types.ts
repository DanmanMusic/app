  ...
  public: {
    Tables: {
      ...
      task_library_attachments: {
        ...
        Relationships: [
          {
            foreignKeyName: 'task_library_attachments_task_library_id_fkey';
            columns: ['task_library_id'];
            isOneToOne: false;
            referencedRelation: 'task_library';
            referencedColumns: ['id'];
      ...
      task_library_urls: {
        ...
        Relationships: [
          {
            foreignKeyName: 'task_library_urls_task_library_id_fkey';
            columns: ['task_library_id'];
            isOneToOne: false;
            referencedRelation: 'task_library';
            referencedColumns: ['id'];
    ...
    Functions: {
      ...
      create_task_with_details: {
        Args: {
          ...
          p_base_tickets: number;
          p_created_by_id: string;
          p_company_id: string;
          p_can_self_assign: boolean;
          p_journey_location_id: string;
      ...
      get_teacher_list_with_stats: {
        Args: { p_company_id: string; p_page?: number; p_limit?: number };
        Returns: {
          id: string;
          first_name: string;
          last_name: string;
