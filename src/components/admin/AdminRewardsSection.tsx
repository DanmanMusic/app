         ...
         <View style={adminSharedStyles.rewardItemContent}>
            ...
            <View style={adminSharedStyles.rewardDetails}>
                ...
                <Text>{item.cost} tickets</Text>
                 {item.description && <Text style={{fontSize: 13, color: '#666'}}>{item.description}</Text>}
            </View>
         </View>
    ...
    return (
        <View>
            ...
            <FlatList
                ...
                ListEmptyComponent={() => <Text style={adminSharedStyles.emptyListText}>No rewards found.</Text>}
            />
        </View>
    );
};