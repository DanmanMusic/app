...
export const AdminView: React.FC<AdminViewProps> = ({
  ...
  const [viewingSection, setViewingSection] = React.useState<
    'dashboard' | 'users' | 'tasks' | 'rewards' | 'history' | 'announcements' | 'instruments'
  >('dashboard');
      ...
      <ScrollView style={adminSharedStyles.container}>
        ...
        <View style={adminSharedStyles.adminNav}>
          <Button
            ...
            color={viewingSection === 'dashboard' ? 'blue' : 'gray'}
          />
          <Button
            title="Users"
            onPress={() => setViewingSection('users')}
            color={viewingSection === 'users' ? 'blue' : 'gray'}
          />
          <Button
            title="Tasks"
            onPress={() => setViewingSection('tasks')}
            color={viewingSection === 'tasks' ? 'blue' : 'gray'}
          />
          <Button
            title="Rewards"
            onPress={() => setViewingSection('rewards')}
            color={viewingSection === 'rewards' ? 'blue' : 'gray'}
          />
          <Button
            title="History"
            onPress={() => setViewingSection('history')}
            color={viewingSection === 'history' ? 'blue' : 'gray'}
          />
          <Button
            title="Announcements"
            onPress={() => setViewingSection('announcements')}
            color={viewingSection === 'announcements' ? 'blue' : 'gray'}
          />
          <Button
            title="Instruments"
            onPress={() => setViewingSection('instruments')}
            color={viewingSection === 'instruments' ? 'blue' : 'gray'}
          />
        </View>
