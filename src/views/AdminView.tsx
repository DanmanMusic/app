...
export const AdminView: React.FC<AdminViewProps> = ({ onInitiateVerificationModal }) => {
  ...
  const pendingVerifications = useMemo(() => assignedTasks.filter(
  ...
  return (
    <SafeAreaView style={appSharedStyles.safeArea}>
       <View style={appSharedStyles.headerContainer}>
         ...
         <Text style={appSharedStyles.header} numberOfLines={1} ellipsizeMode="tail"> Admin: {getUserDisplayName(adminUser)} </Text>
      ...
      <ScrollView style={appSharedStyles.container}>
        ...
        {viewingSection === 'users' && (
          <AdminUsersSection
            ...
            onAssignTask={(taskId, studentId) => simulateAssignTask(taskId, studentId, currentUserId)} 
            taskLibrary={taskLibrary}
        ...
        {viewingSection === 'history' && (
          <AdminHistorySection allTicketHistory={ticketHistory} />
        )}
