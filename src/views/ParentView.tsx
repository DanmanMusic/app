                              ...
                              <View key={student.id} style={styles.studentItem}>
                                  <Text style={styles.studentName}>{student.name}</Text>
                                   ...
                                   <Text>Balance: {student.balance} Tickets</Text>
                                    <Button title={`View ${student.name}'s Profile`} onPress={() => setViewingStudentId(student.id)} />
                              </View>
                         ))
                     ) : (
                         <Text style={styles.emptyListText}>No students linked yet. Ask the school admin to link your child.</Text>
                     )}
