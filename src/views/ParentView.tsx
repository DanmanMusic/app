...
export const ParentView: React.FC<ParentViewProps> = () => {
    ...
    return (
      <SafeAreaView style={appSharedStyles.safeArea}>
        <View style={appSharedStyles.container}>
          <Text>Error: Could not load parent data.</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  if (currentViewingStudentId) {
    ...
    const studentDisplayName = studentUserForHeader
      ? getUserDisplayName(studentUserForHeader)
      : 'Student Profile';
                ...
                <View key={student.id} style={appSharedStyles.itemContainer}>
                  ...
                  <View style={styles.studentActions}>
                    <Button
                      ...
                      onPress={() => handleSetViewingStudent(student.id)}
                    />
                  </View>
                </View>
              );
